...
const contractAddress = "0xeac4fdd87005483A7C28F5ed61919717D124b394";
  ...
  return (
    ...
    <>
      ...
      <div id="" className="connect__pos">
        <div className="flex_32" onClick={connectHandler}>
          {/* {connButtonText} */}
          {walletConnected ? (
            <>
              <img className="img_conect1" src="/images/mint.png" alt="" />
            </>
          ) : (
            <>
